...
namespace Quiz_Sor_Pergunta
{
    public partial class WebForm5 : System.Web.UI.Page
    {
        ...
        string[] sort = new string[] { "110+112", "266+211", "444+222" };
        string[] resp1 = new string[] { "222", "231", "2452" };
        string[] resp2 = new string[] { "477", "345", "34634" };
        string[] resp3 = new string[] { "666", "6727", "882" };
